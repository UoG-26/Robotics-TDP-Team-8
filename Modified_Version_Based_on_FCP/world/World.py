...
from cpp.ball_predictor import predict_rolling_ball as _bp_predict, get_intersection as _bp_intersect
class _BallPredictor:
    @staticmethod
    def predict_rolling_ball(*args, **kwargs):
        return _bp_predict(*args, **kwargs)
    @staticmethod
    def get_intersection(*args, **kwargs):
        return _bp_intersect(*args, **kwargs)
ball_predictor = _BallPredictor

from cpp.localization import compute as _loc_compute
class _Localization:
    @staticmethod
    def compute(*args, **kwargs):
        return _loc_compute(*args, **kwargs)
